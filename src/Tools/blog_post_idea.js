...
export default function BlogPostIdea() {
  ...
  const generateMetaTitle = async () => {
    ...
    setTimeout(async () => {
      try {
        const response = await fetch("http://localhost:4000/seobpirmo", {
          method: "POST",
          headers: {
    ...
    <div>
      ...
      <section className="topcontainerx text-center py-4">
        <div className="container">
          <h1 className="display-3 headrankmeone">Blog Post Ideas</h1>
          ...
          <div className="col-md-6 order-1 order-md-2">
            <div style={styles.card}>
              ...
              <input
                ...
                placeholder="Enter your blog niche here.."
                value={inputText}
