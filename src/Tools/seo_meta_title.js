...
export default function SeoMetaTitle() {
  ...
  const generateMetaTitle = async () => {
    ...
    setTimeout(async () => {
      try {
        const response = await fetch("http://localhost:4000/seomtrmo", {
          method: "POST",
          headers: {
    ...
    <div>
      ...
      <section className="topcontainerx text-center py-4">
        <div className="container">
          <h1 className="display-3 headrankmeone">SEO Meta Title</h1>
          <p className="lead headdesc">
            Generate optimized meta titles for better SEO results and higher
            search rankings.
          </p>
        </div>
      </section>
      ...
      <section style={styles.container} className="container">
        <div className="row">
          ...
          <div className="col-md-6 order-1 order-md-2">
            <div style={styles.card}>
              ...
              <input
                ...
                placeholder="Enter your content or keywords here..."
                value={inputText}
              ...
              <div
                ...
                style={{
                  ...styles.wordCount,
                  ...(wordCount > 10 ? styles.wordCountWarning : {}),
                }}
              >
                {wordCount}/10
              </div>
              ...
              {responseText && (
                <div>
                  <div className="justify-content-center align-content-center d-flex text-center">
                    <textarea
                      className="text-center justify-content-center align-content-center d-flex "
            ...
            <div className="infoCon" style={styles.infoText}>
              <p className="infoText">
                "Optimize your web content with our SEO Meta Title Tool. Enter
                your keywords to get customized meta titles that enhance SEO and
                attract clicks.{" "}
          ...
          <h5 className="text-center">Advertisment</h5><hr />
            {/* Sidebar ad. */}
      ...
      <p className="iframetitle" style={{fontWeight: "bold"}}>How To Unlock Canva Pro for Free 2024 (Step By Step)</p>
