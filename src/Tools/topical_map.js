...
export default function TopicalMap() {
  ...
  const generateMetaTitle = async () => {
    ...
    setTimeout(async () => {
      try {
        const response = await fetch("http://localhost:4000/seotprmo", {
          method: "POST",
          headers: {
    ...
    <div>
      ...
      <section className="topcontainerx text-center py-4">
        <div className="container">
          <h1 className="display-3 headrankmeone">Topical Map Generator</h1>
          <p className="lead headdesc">
          Generate a topical map to enhance SEO and improve search visibility
          </p>
        </div>
      </section>
      {error && (
          ...
          <div className="col-md-6 order-1 order-md-2">
            <div style={styles.card}>
              ...
              <input
                ...
                placeholder="Enter your main title / topic here.."
                value={inputText}
