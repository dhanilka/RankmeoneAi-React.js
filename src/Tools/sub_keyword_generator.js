...
export default function SubKeywordGenerator() {
  ...
  const generateMetaTitle = async () => {
    ...
    setTimeout(async () => {
      try {
        const response = await fetch("http://localhost:4000/seoskrmo", {
          method: "POST",
          headers: {
    ...
    <div>
      ...
      <section className="topcontainerx text-center py-4">
        <div className="container">
          <h1 className="display-3 headrankmeone">Sub Keyword Generator</h1>
          <p className="lead headdesc">
          Generate targeted sub-keywords to enhance SEO strategies and improve search visibility.
          </p>
        </div>
      </section>
      {error && (
          ...
          <div className="col-md-6 order-1 order-md-2">
            <div style={styles.card}>
              ...
              <input
                ...
                placeholder="Enter your focus / main keyword here..."
                value={inputText}
  ...
  "Boost your SEO strategy with our Sub Keyword Generator. Enter your main keywords to generate a list of targeted sub-keywords that enhance content relevance and improve search rankings.{" "}
